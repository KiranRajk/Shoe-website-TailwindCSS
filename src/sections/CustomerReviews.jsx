...
const CustomerReviews = () => {
  return (
    <section className="max-container">
      ...
      <p className="text-center info-text m-auto mt-4  max-w-lg text-slate-gray">Hear genuine stories from our satisfied customers about their exceptional experiences with us.</p>
